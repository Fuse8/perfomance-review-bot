...
- [tasks/](tasks/) - активные задачи, список завершенных задач и архив.
- [adr.md](adr.md) - короткий список устойчивых технических решений.
- [product-spec.md](product-spec.md) - описание продукта и сценариев.
- [development.md](development.md) - локальная разработка.
- [workflow.md](workflow.md) - процесс ведения задачи от планирования до deploy.
